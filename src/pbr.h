...
struct standard_device_objects
{
    ...
    rhi::image create_cubemap_from_spheremap(int width, gfx::descriptor_pool & desc_pool, gfx::dynamic_buffer & uniform_buffer, rhi::image spheremap, const coord_system & preferred_coords)
    {
    ...
    rhi::image create_irradiance_cubemap(int width, gfx::descriptor_pool & desc_pool, gfx::dynamic_buffer & uniform_buffer, rhi::image cubemap)
    {
    ...
    rhi::image create_reflectance_cubemap(int width, gfx::descriptor_pool & desc_pool, gfx::dynamic_buffer & uniform_buffer, rhi::image cubemap)
    {
