...
gfx::window::window(std::shared_ptr<rhi::device> dev, const int2 & dimensions, const std::string & title) : dev{dev}, rhi_window{dev->create_window(dimensions, title)}, glfw_window{dev->get_glfw_window(rhi_window)}
{
